...
export default function LoginPage() {
    ...
    const [username, setUsername] = useState(""); // Used only for signup UI, actual creation handled by trigger
    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (isLogin) {
                ...
                // For signup, pass username as metadata so the SQL trigger can pick it up for the profile name
